...
bool cl_switches::bF_Level_Pulse_mem;
bool cl_switches::bF_Level_MonMode_mem;
bool cl_switches::bF_Level_TxRS485_mem;
bool cl_switches::bF_Level_PwrSense_mem;
bool cl_switches::bF_Level_Mute_mem;
bool cl_switches::bF_Level_AlmReset_mem;
bool cl_switches::bF_Level_SysWakeup_mem;
bool cl_switches::bF_Level_SysMode_mem;
uint8_t cl_switches::ui8_Switches_JustPressed_bitpat;
bool cl_switches::bF_SwPressed; //1=a switch has been pressed
//.............................................................................
...
//::---------------------------------------------------------------------------
bool cl_switches::read_Level_TxRS485(){
    bF_Level_TxRS485_mem =  read_DI_PB2();
    return bF_Level_TxRS485_mem;
}
//::---------------------------------------------------------------------------
bool cl_switches::is_pressed_TxRS485(){
    bF_Level_TxRS485_mem =  read_DI_PB2();
    return (bF_Level_TxRS485_mem ? false : true);
}
//::---------------------------------------------------------------------------
bool cl_switches::is_justPressed_TxRS485(){
    bool bF_JustPressed;
    bool bF_CurrLevel; //Current level of switch
...
//::---------------------------------------------------------------------------
bool cl_switches::is_released_TxRS485(){
    bF_Level_TxRS485_mem =  read_DI_PB2();
    return (bF_Level_TxRS485_mem ? true : false);
}
//::---------------------------------------------------------------------------
bool cl_switches::is_justReleased_TxRS485(){
    bool bF_JustReleased;
    bool bF_CurrLevel;
...
//--- Sw_Mute          // PE0        9   J2p3
//::---------------------------------------------------------------------------
bool cl_switches::read_Level_Mute(){
    bF_Level_Mute_mem =  read_DI_PE0();
    return bF_Level_Mute_mem;
}
//::---------------------------------------------------------------------------
bool cl_switches::is_pressed_Mute(){
    bF_Level_Mute_mem =  read_DI_PE0();
    return (bF_Level_Mute_mem ? false : true);
}
//::---------------------------------------------------------------------------
bool cl_switches::is_justPressed_Mute(){
    bool bF_JustPressed;
    bool bF_CurrLevel; //Current level of switch
...
//::---------------------------------------------------------------------------
bool cl_switches::is_released_Mute(){
    bF_Level_Mute_mem =  read_DI_PE0();
    return (bF_Level_Mute_mem ? true : false);
}
//::---------------------------------------------------------------------------
bool cl_switches::is_justReleased_Mute(){
    bool bF_JustReleased;
    bool bF_CurrLevel;
...
//::---------------------------------------------------------------------------
bool cl_switches::read_Level_AlmReset(){
    bF_Level_AlmReset_mem =  read_DI_PA4();
    return bF_Level_AlmReset_mem;
}
//::---------------------------------------------------------------------------
bool cl_switches::is_pressed_AlmReset(){
    bF_Level_AlmReset_mem =  read_DI_PA4();
    return (bF_Level_AlmReset_mem ? false : true);
}
//::---------------------------------------------------------------------------
bool cl_switches::is_justPressed_AlmReset(){
    bool bF_JustPressed;
    bool bF_CurrLevel; //Current level of switch
...
//::---------------------------------------------------------------------------
bool cl_switches::is_released_AlmReset(){
    bF_Level_AlmReset_mem =  read_DI_PA4();
    return (bF_Level_AlmReset_mem ? true : false);
}
//::---------------------------------------------------------------------------
bool cl_switches::is_justReleased_AlmReset(){
    bool bF_JustReleased;
    bool bF_CurrLevel;
...
//--- Monitor Switches
//::---------------------------------------------------------------------------
void cl_switches::set_SwPressed_bitpat(uint8_t ui8Usr_Sw_BitPat){
    ui8_Switches_JustPressed_bitpat |= ui8Usr_Sw_BitPat;
}
//::---------------------------------------------------------------------------
void cl_switches::clr_SwPressed_bitpat(){
    ui8_Switches_JustPressed_bitpat = en_Sw_None_bp; //=0x00
}
//::---------------------------------------------------------------------------
uint8_t cl_switches::read_SwPressed_bitpat(){ //Switch press sets a bit to 1
    return ui8_Switches_JustPressed_bitpat;
}
//::---------------------------------------------------------------------------
bool cl_switches::check_SwPressed_any(){ //>0 => 1 or more switch has been pressed
    return (ui8_Switches_JustPressed_bitpat > 0) ? true : false;
}
//::---------------------------------------------------------------------------
bool cl_switches::is_SwPressed_any(){ //1=a sw was pressed, auto clear bitpat
    bool bF_Status;
...
//---^^^ Sw Interrupts
//::---------------------------------------------------------------------------
void cl_switches::setup_Interrupt_PortA(){ //~IRQ: PA4,
...
//::---------------------------------------------------------------------------
void cl_switches::setup_Interrupt_PortB(){ //~IRQ: PB0,2,7
...
//::---------------------------------------------------------------------------
void cl_switches::setup_Interrupt_PortE(){ //~IRQ: PE0
...
//::---------------------------------------------------------------------------
void cl_switches::setup_Interrupt_PortF(){ //~IRQ: PF0,4
